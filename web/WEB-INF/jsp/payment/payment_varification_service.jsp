...
<form id="reg_form" class="w3-container w3-display-middle" action="controller" method="post">
    ...
    <input type="hidden" name="to" value="${to}"></p>
    <input type="hidden" name="id_account_service" value="${id_account_service}"></p>
    <p><label><fmt:message key="paymentInternet.label2" var="textValue" />
            ${textValue}</label>
        <label>${personal_account}</label></p>
